...
export function ClientPortal() {
  ...
  if (checking) return <main className="private-loading"><img src="/logo-impulsa-fit.webp" alt="IMPULSA FIT" /><span>Cargando tu área…</span></main>;
  ...
  return <main className="client-app">
    <header className="client-topbar"><Link href="/"><ArrowLeft size={18} /> Web pública</Link><img src="/logo-impulsa-fit.webp" alt="IMPULSA FIT" /><button onClick={logout}><LogOut size={17} /> Salir</button></header>
